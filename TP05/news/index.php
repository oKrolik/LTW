...
<body>
    ...
    <section id="news">
        ...
        <article>
            <header>
                <h1><a href="item.php">Vivamus fermentum dui nisi, at posuere</a></h1>
            </header>
            ...
            <footer>
                ...
                <span class="tags"><a href="index.php">#local</a> <a href="index.php">#life</a></span>
                <span class="date">2h</span>
                <a class="comments" href="item.php#comments">0</a>
            </footer>
        </article>
        <article>
            <header>
                <h1><a href="item.php">Donec placerat tempor ex sit amet</a></h1>
            </header>
            ...
            <footer>
                ...
                <span class="tags"><a href="index.php">#nature</a> <a href="index.php">#science</a></span>
                <span class="date">17h</span>
                <a class="comments" href="item.php#comments">2</a>
            </footer>
        </article>
        <article>
            <header>
                <h1><a href="item.php">Lorem ipsum dolor sit amet, consectetur</a></h1>
            </header>
            ...
            <footer>
                ...
                <span class="tags"><a href="index.php">#transports</a> <a href="index.php">#vehicles</a></span>
